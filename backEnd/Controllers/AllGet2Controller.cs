...
namespace backEnd.ControllersForTesting
{
    ...
    public class AllGet2Controller : Controller
    {
        ...
        public AllGet2Controller(PaintStoreContext ctx)
        {
        ...
        public IEnumerable<String> GetAllComments()
        {
            ...
            {
                foreach (var comm in db.CategoryTypes)
                {
                    stringBuilder.Append("{ ");
                    stringBuilder.Append(comm.Id);
                    stringBuilder.Append(", ");
                    stringBuilder.Append(comm.TypeName);
                    stringBuilder.Append(", ");
        ...
        public IEnumerable<String> GetAllImages()
        {
            ...
            using (var db = paintStoreContext)
            {
                foreach (var comm in db.CategoryTools)
                {
                    stringBuilder.Append("{ ");
                    stringBuilder.Append(comm.Id);
                    stringBuilder.Append(", ");
